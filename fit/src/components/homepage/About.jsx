  ...
  const iconMap = {
    'dumbbell': (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6h18M3 12h18m-9 6l3-3-3-3m0 0H3" />
      </svg>
    ),
    'nutrition': (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="p-2">
                ...
                <div className="p-4 sm:p-6 pt-2">
                  ...
                  <div className="text-center">
                    <Link 
                      to={feature.link}
                      className={`inline-flex items-center px-4 sm:px-6 py-2 rounded-full ${feature.bglight} ${feature.textcolor} font-medium transition-all ${feature.hoverbg} hover:shadow-md`}
                    >
                      {feature.linkText}
